...
/**
 * This class is a native wrapper for the base MDCTextfield from the
 ...
 * @see https://github.com/material-components/material-components-web/blob/master/packages/mdc-textfield/index.js
 * @see http://material-components-web.appspot.com/textfield.html
 * 
...
public class MdcTextfieldComponent extends MdcInputComponent<MdcTextfieldFoundation> {
  ...
  @JsConstructor
  public MdcTextfieldComponent(HTMLElement element) {
  ...
  @JsMethod
  public static native MdcTextfieldComponent attachTo(HTMLElement element);
