...
/**
 * This class is a native wrapper for the base MDCSnackbar from the
 ...
 * @see https://github.com/material-components/material-components-web/blob/master/packages/mdc-snackbar/index.js
 * @see http://material-components-web.appspot.com/snackbar.html
 * 
 ...
 */
@JsType(isNative = true, namespace = "mdc.snackbar", name = "MDCSnackbar")
public class MdcSnackbarComponent extends MdcBaseComponent<MdcSnackbarFoundation> {

  @JsConstructor
  public MdcSnackbarComponent(HTMLElement element) {
  ...
  @JsMethod
  public static native MdcSnackbarComponent attachTo(HTMLElement element);

  @JsMethod(name = "show")
  //public native boolean show(MdcSnackbarData data);
  public native boolean show(MdcSnackbarData data);
